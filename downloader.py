...
# link = "https://e-hentai.org/g/2821038/775dd5f2e6/"
# link = "https://e-hentai.org/g/2817976/2c6fe02cec/"
# https://e-hentai.org/g/2812014/316e748872/
...
but still downloading :)""")
    ...
    for i in FinalPageLinks:
        if get_downloadeds(i.split("/")[-1],GN):
            ...
            strprint = i + " "*(terminalx-len(i)-len(imglimit)-11)+f"|{imglimit}| "+ctime()[11:-5]
            print(strprint,end="\r")
            download_image(i)
        else:
            terminalx = get_terminal_size().columns
            print(i.split("/")[-1]+".png already exesits"+ " "*(terminalx-len(i.split("/")[-1])-21),end="\r")
            sleep(0.02)
    print()
